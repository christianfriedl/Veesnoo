...
BINARIES="$BINARIES testMemleak "
BINARIES="$BINARIES testTable "
BINARIES="$BINARIES testColorAttribute "
...
TESTOBJECTS="$TESTOBJECTS testMemleak.o "
TESTOBJECTS="$TESTOBJECTS testTable.o "
TESTOBJECTS="$TESTOBJECTS testColorAttribute.o "
