...
int main() {
    @autoreleasepool {
        ...
        NVMenuItem *m5 = [[NVMenuItem alloc] initWithParent: win Text: @"item5" X: 0 Y: 0];
        NVMenuItem *m6 = [[NVMenuItem alloc] initWithParent: win Text: @"item6" X: 0 Y: 0];
        NVMenuItem *m7 = [[NVMenuItem alloc] initWithParent: win Text: @"item7" X: 0 Y: 0];
        NVMenuItem *m8 = [[NVMenuItem alloc] initWithParent: win Text: @"item8" X: 0 Y: 0];
